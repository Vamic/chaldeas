...
madness = passive "Madness Enhancement" IconTeeth
  [ Give Self (Performance Buster)
    [ EX: 12.0, APlus: 11.0, A: 10.0, B: 8.0, C: 6.0, DPlus: 5.0, D: 4.0
    , EPlus: 3.0, E: 2.0, EMinus: 1.0
    ]
  ]
...
magicResistance = passive "Magic Resistance" IconDiamonds
  [ Give Self DebuffResist
    [ EX: 25.0, APlus: 21.0, A: 20.0, BPlus: 18.0, BPlus: 18.0, B: 17.5
    , CPlus: 15.5, C: 15.0, DPlus: 13.0, D: 12.5, E: 10.0
    ]
  ]
...
riding = passive "Riding" IconHorse
  [ Give Self (Performance Quick)
    [ EX: 12.0, APlusPlus: 11.5, APlus: 11.0, A: 10.0, B: 8.0, CPlus: 7.0
    , C: 6.0, E: 2.0
    ]
  ]
